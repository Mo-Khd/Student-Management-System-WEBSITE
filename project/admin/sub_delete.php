...
if($button_check == "delete"){
        $sql = "DELETE FROM subject_table WHERE subject_id = ?";
        $stmt = $db->prepare($sql);
...
<div class="navbar1">
  ...
  <div class="subnav1">
    <button class="subnav1btn" style="background-color: #a57ccb;">Delete<i class="fa fa-caret-down"></i></button>
    <div class="subnav1-content">
      <a class="selected1" href="sub_delete.php">Delete subject</a>
    </div>
    </div>
...
<?php
$sql = "SELECT subject_id, sub_name, grade, teacher_id FROM subject_table, year_table WHERE subject_table.year_id = year_table.year_id";
...
while ($row = mysqli_fetch_assoc($stmt)) {
           ...
           $sub_id  = $row["subject_id"];
            echo ' <p><input type="hidden" name="sub_id'  .$row_number. '" value="' .$sub_id. '"></p>';
