...
if($button_check == "delete"){
        $sql = "DELETE FROM student WHERE st_id = ?";
        $stmt = $db->prepare($sql);
...
$sql = "SELECT st_id, first_name, last_name, gender, date_and_birth, address FROM student";
...
while ($row = mysqli_fetch_assoc($stmt)) {
           ...
           $st_id  = $row["st_id"];
            echo '<p><input type="hidden" name="st_id'  .$row_number. '" value="' .$st_id. '"></p>';
           ...
           echo "<li><a class='ed' href='s_update.php?id=" .$row['st_id']. "'data-tip='edit'><i class='fa fa-edit'></i></a></li></ul></td>"; 
            echo '
